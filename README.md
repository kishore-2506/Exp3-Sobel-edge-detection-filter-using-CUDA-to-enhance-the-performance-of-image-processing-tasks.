...
<h3>ENTER YOUR REGISTER NO : 212223040100 </h3>
<h3>EX. NO : 3</h3>
...
__global__ void sobelFilter(unsigned char *srcImage, unsigned char *dstImage,
    ...
    if (x >= 1 && x < width-1 && y >= 1 && y < height-1) {
        ...
        for(int i=-1;i<=1;i++){
            for(int j=-1;j<=1;j++){
                int pixel = srcImage[(y+i)*width + (x+j)];
...
int main() {
    ...
    Mat image = imread("/content/batman-red-3840x2160-19038.jpg", IMREAD_GRAYSCALE);
...
~~~
## OUTPUT:
<img width="1345" height="695" alt="exp 3" src="https://github.com/user-attachments/assets/41cb59ce-b005-4910-ba69-4b7b27cd5a3f" />
